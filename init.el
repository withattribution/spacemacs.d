  ...
  (setq-default
   ...
   '(
     ...
     (syntax-checking :variables
                      syntax-checking-use-orginal-bitmaps t)

     (treemacs :variables
               treemacs-indention 1
...
If you are unsure, try setting them in `dotspacemacs/user-config' first."
  ...
  ;;squash cl deprecated warning https://github.com/kiwanami/emacs-epc/issues/35
...
before packages are loaded."
  ...
  (defun withattribution/setup-custom-doom-modeline ()
    (doom-modeline-set-modeline 'withattribution-modeline 'default))

  (with-eval-after-load 'doom-modeline
    (doom-modeline-def-modeline 'withattribution-modeline
    ...
    (withattribution/setup-custom-doom-modeline))
